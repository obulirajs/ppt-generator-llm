...
PRESENTATION_TYPES = {
    'report': {
        ...
        'keywords': [
            'analysis', 'findings', 'research', 'data', 'conclusion', 
            'summary', 'executive summary', 'recommendations', 'insights', 
            'trends', 'statistics', 'metrics', 'evaluation', 'assessment'
        ],
        'keyword_weight': 1.0,
        'default_sections': [
    ...
    'pitch': {
        ...
        'keywords': [
            'investment', 'funding', 'investor', 'startup', 'venture', 
            'market opportunity', 'business model', 'revenue', 'growth', 
            'valuation', 'series', 'seed', 'roi', 'equity', 'traction',
            'competitive advantage', 'scalability', 'runway'
        ],
        'keyword_weight': 1.5,
        'default_sections': [
    ...
    'business_review': {
        ...
        'keywords': [
            'quarterly', 'q1', 'q2', 'q3', 'q4', 'ytd', 'performance', 
            'metrics', 'kpi', 'achievement', 'review', 'targets', 
            'goals', 'objectives', 'progress', 'dashboard', 'scorecard',
    ...
    'client_success': {
        ...
        'keywords': [
            'success story', 'testimonial', 'transformation', 'journey', 
            'achievement', 'milestone', 'improvement', 'satisfaction', 
            'partnership', 'collaboration', 'value delivered', 'impact',
    ...
    'case_study': {
        ...
        'keywords': [
            'case study', 'client', 'challenge', 'solution', 'implementation', 
            'results', 'success', 'problem', 'approach', 'outcome', 
            'impact', 'benefits', 'lessons learned', 'best practices',
    ...
    'presales': {
        ...
        'keywords': [
            'demonstration', 'demo', 'features', 'capabilities', 'benefits', 
            'technical', 'architecture', 'integration', 'platform', 
            'solution overview', 'specifications', 'requirements', 'poc',
            'proof of concept', 'evaluation', 'trial'
        ],
        'keyword_weight': 1.1,
        'default_sections': [
    ...
    'proposal': {
        ...
        'keywords': [
            'proposal', 'proposed', 'project', 'timeline', 'deliverables', 
            'budget', 'scope', 'requirements', 'solution', 'approach', 
            'methodology', 'pricing', 'terms', 'contract', 'statement of work',
            'milestones', 'resources', 'assumptions'
        ],
        'keyword_weight': 1.4,
        'default_sections': [
            {'name': 'Executive Summary', 'min_slides': 1, 'max_slides': 2, 'bullets_per_slide': 4},
